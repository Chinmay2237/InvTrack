          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  const Color.fromRGBO(215, 117, 255, 1).withAlpha(128),
                  const Color.fromRGBO(255, 188, 117, 1).withAlpha(230),
                ],
                ...
                children: <Widget>[
                  Flexible(
                    child: Container(
                      ...
                      transform: Matrix4.rotationZ(-8 * 3.14 / 180)..translate(-10.0, 0.0),
                      decoration: BoxDecoration(
